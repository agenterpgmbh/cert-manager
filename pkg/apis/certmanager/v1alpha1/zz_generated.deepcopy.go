...
func (in *ACMEChallengeSolverHTTP01) DeepCopyInto(out *ACMEChallengeSolverHTTP01) {
	*out = *in
	...
	if in.Ambassador != nil {
		...
		*out = new(ACMEChallengeSolverHTTP01Ambassador)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACMEChallengeSolverHTTP01Ambassador) DeepCopyInto(out *ACMEChallengeSolverHTTP01Ambassador) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEChallengeSolverHTTP01Ambassador.
func (in *ACMEChallengeSolverHTTP01Ambassador) DeepCopy() *ACMEChallengeSolverHTTP01Ambassador {
	if in == nil {
		return nil
	}
	out := new(ACMEChallengeSolverHTTP01Ambassador)
